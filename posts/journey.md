...
Now, at 21, as the year comes to a close and marking roughly four years since I started learning to code I find myself reflecting. I figured it'd be a good time finally share my story going from a newbie programmer to a mid-level software engineer at Tesla.
...
Around the same time, I’d just watched Fincher's masterpiece: [The Social Network](https://www.imdb.com/title/tt1285016/) (I know, how cliche), and let me just say that it indeed did have a profound impact on me to start learning to code.

I started doing some research into learning this thing called coding, so I went through a bunch of different resources on YouTube and whatnot, but I ended up sticking with learning HTML/CSS on [freeCodeCamp](https://www.freecodecamp.org). No specific reason as to why, but I guess it was nice having that quick feedback loop of seeing your code visually do something.
...
Fun fact: the worst grade I got in my GCSE exams (the ones you take before A-Levels/BTECs) was in computer science. In that class we learned the basics of Python, and I remember while doing this Udemy course that I regretted so many of my choices to not be better in school. I was a bright kid, yet somehow could never get good grades because I was so obsessed with playing video games, and kinda fell with the wrong crowd.
...
One script I wrote was a web scraper to notify when the PS5 was back in stock on Amazon. Sure it’s the most basic thing you could build, but I just felt so proud of it.

But I still felt quite limited in what I could do on the web. Everything felt so vanilla, lacked the sauce. Naturally I gravitated towards acquiring the final infinity stone for building websites: JavaScript. I stumbled upon [The Odin Project](https://www.theodinproject.com/), and I remember this being a pretty solid course to learn JS/Node.
...
He proceeded to tell me to give me a step by step guide on building a website from scratch, using pure HTML/CSS. I was mind blown, I immediately switched over to hosting on GitHub Pages, and thus the inception of my new open source website was [born](https://github.com/pzrsa/parsam.io/commit/7927cccdda9843bdc7c4b17ff80626516d628301).
...
Now that I was on track to study CS, I started taking a deeper look at the job/internship opportunities. I'd already learned about FAANG, so as any aspiring CS student does I took a look around at the big tech companies, hoping I'd one day join them.

And on the Google careers page, I stumbled upon an opportunity that would change the course of my life. It was an early careers software engineering program, and I just applied to it without thinking much to it.

I'd also just brushed up my resume, so I figured it would be a good time to apply to some places to get some work experience before university. Regarding my resume, it wasn't anything special. But I must admit I did spend a good amount of time polishing it, and I had a bunch of things like personal projects that recruiter appreciate.

I got a response in 4 days.

I then ended up doing the typical technical interviews for the next few months, grinding Leetcode, and reaching out to strangers on the internet to give me mock interviews.
...
Keep in mind that while I was doing these interviews, I was still on track for university in September. I went to the open day and spoke with the existing students to get a grasp of the course. I wasn't feeling it at all, but I had no other choice really.

A deadline was set for students to finalise their accommodation before the term started, and I still held off on it until my interviews concluded. I had 2 days left, then I got a call from Google. I got the job offer.

After a lot of thinking, I cancelled my university placement and accepted the offer to join Google with a start date in September 2021.
...
Also, you can ask any current or former Google engineer, they can't deny the fact that the developer experience they've built is incredible. From code searching, editing, reviews, deployment, etc. Everything is in house, and it just works somehow. Felt like magic to me.

In this time I worked on some interesting stuff, like improving the messaging pipeline using Java, and building a CLI to speed up tedious process saving hours engineering time each month. My learning at this rate was exponential, I was learning how to build real software for millions.

However, after about 9 months on the team, I had a discussion to switch teams after I saw an opportunity that just had to take: to join the Web on Android team. This team had me split across 2 orgs, Chrome and Android.

I was absolutely excited to work on two of the biggest open source projects in the world. I felt like my experience of being hungry to learn more about the web space got me my feet in the door.

I worked on a feature called WebAPKs, which enabled users to install web apps as a native Android app. I wrote mostly Go code, but towards the end of my tenure I started writing some C++ which was also very interesting.
...
However, an opportunity popped up which had the perfect combination of everything I wanted in a new job. Tesla. Operates like a startup. My friend Cyrus kindly referred me, I'm forever grateful for him.
...
Tesla was perfect for this as I would move to Berlin, not far from London. Although it is Germany so different language, Berlin is quite fine since in most situations I find myself I don't need to speak the German language. I started learning it about a month ago now.
...
Funnily enough I was also interviewing with another Elon company, X. At this point I'd already received the Tesla offer so didn't proceed with the other rounds, but it was still a great learning experience.

# Working at Tesla

I've been at Tesla since April 2024, and it has been one hell of a ride so far. I don't even know where to begin, but I can start by saying that it was definitely tough after the first few months. I feel like the excitement worn off, so I felt a lot of pressure suddenly weighing on me that I didn't expect.

But now I feel like I have a good routine going on, which is what I at least wanted after I had finished probation.

My team is incredible, I feel like we get along with each other really well. I'm sure at least one of is going to read this post. While on this topic, one thing I've learned about teams is that you could have the best product in the world, but if the people in your team don't enjoy working together then what's the point? I'm glad I realised early on what a good team looks like because in all my cases I've gotten along so well with them. There's probably a difference between a team who get along at work and a team who you can also go out and enjoy with.
...
Ever since I made this change I've been on a constant cycle of change. Every interaction and decision I make now somehow plays into this idea that makes me want to improve it. I remember in my first few months of Google, on the tube back home I'd reflect on the day completely and ask myself a bunch of questions. Everyone does this to some extent, but I often feel like it can be damaging since I never feel stable. I don't hear people speak about this, so I certainly hope I'm not alone.

It's also worth mentioning that if you get into the game early, you're going to always feel like the youngest. Still to this day, I've not worked with someone who was younger than me. It matures you like crazy, and the people you're going to hang out with will be much older than you. It doesn't sound like much, but it does affect you to some extent. You can never feel connected to the people your age who are still studying and doing the typical stuff. Don't get me wrong I'm super grateful for this, but I get this feeling that I somehow fast tracked my way, and I can't afford to stop.

I want to take the time to say thank you so much for reading this far. It means the world to me, and I hope it was of some value to you.
